...
processList = {
    # 'wzp6_ee_mumuH_ecm240':{'chunks':3}, #did
    # "p8_ee_WW_mumu_ecm240":{'chunks':3}, # too long #en cours
    # 'p8_ee_ZZ_ecm240':{'chunks':3}, # too long #en cours
    # 'wzp6_ee_mumu_ecm240':{'chunks':10}, #did
    # 'wzp6_egamma_eZ_Zmumu_ecm240':{'chunks':3}, #did
    # 'wzp6_gammae_eZ_Zmumu_ecm240':{'chunks':3}, #did
    # "wzp6_gaga_mumu_60_ecm240":{'chunks':3} #too long #done
}
...
outputDir="/eos/user/k/kdewyspe/25_April/FCCee/MidTerm/mumu/MVAInputs/" # Local run 
eosType = "eosuser"
...
class RDFanalysis():
    ...
    def analysers(df):
        df2 = (
            ...
            #.Define("MissingET", "MissingET") # add 29/03/24
