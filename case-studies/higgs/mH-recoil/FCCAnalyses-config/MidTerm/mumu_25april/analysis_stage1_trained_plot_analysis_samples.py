...
energy         = 240.0
collider       = 'FCC-ee'
inputDir       = '/eos/user/k/kdewyspe/25_April/FCCee/MidTerm/mumu/BDT_analysis_samples/final/'
...
#yaxis          = ['lin']
outdir         = '/eos/user/k/kdewyspe/25_April/FCCee/MidTerm/mumu/BDT_analysis_samples/plots/'
...
# plots['ZH'] = {'signal':{'mumuH':['wzp6_ee_mumuH_ecm240']},
#                'backgrounds':{'gagamumu':["wzp6_gaga_mumu_60_ecm240"],
#                                 'WW':['p8_ee_WW_ecm240'],
#                                 'rare':["wzp6_ee_tautau_ecm240",
#                                         "wzp6_gaga_tautau_60_ecm240",
#                                         "wzp6_ee_nuenueZ_ecm240"],
