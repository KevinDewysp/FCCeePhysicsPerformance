...
processList = {
    # #signal
    # "wzp6_ee_mumuH_ecm240":{'chunks':3}, #20 #done
    # #signal mass
    # "wzp6_ee_mumuH_mH-higher-100MeV_ecm240":{'chunks':1}, #20
    # "wzp6_ee_mumuH_mH-higher-50MeV_ecm240":{'chunks':1}, #20
    # "wzp6_ee_mumuH_mH-lower-100MeV_ecm240":{'chunks':1}, #20
    # "wzp6_ee_mumuH_mH-lower-50MeV_ecm240":{'chunks':1}, #20
    # #signal syst
    # "wzp6_ee_mumuH_BES-higher-1pc_ecm240":{'chunks':1}, #20
    # "wzp6_ee_mumuH_BES-lower-1pc_ecm240":{'chunks':1}, #20
    # #background: 
    "p8_ee_WW_ecm240":{'chunks':10}, #80 #en cours #+condor
    # "p8_ee_ZZ_ecm240":{'chunks':3}, #20 #en cours
    # "wzp6_ee_mumu_ecm240":{'chunks':3}, #20 #en cours
    # "wzp6_ee_tautau_ecm240":{'chunks':3}, #20 #en cours
    # #rare backgrounds:
    # "wzp6_egamma_eZ_Zmumu_ecm240":{'chunks':3}, #20 #en cours
    # "wzp6_gammae_eZ_Zmumu_ecm240":{'chunks':3}, #20 #en cours
    # "wzp6_gaga_mumu_60_ecm240":{'chunks':3}, #20 #en cours
    # "wzp6_gaga_tautau_60_ecm240":{'chunks':3}, #20 #en cours
    # "wzp6_ee_nuenueZ_ecm240":{'chunks':3}, #20 #en cours 
    }
...
#outputDirEos= "/eos/user/k/kdewyspe/21_March/FCCee/MidTerm/mumu/BDT_analysis_samples_1/"
outputDirEos= "/eos/user/k/kdewyspe/25_April/FCCee/MidTerm/mumu/BDT_analysis_samples_condor/"
eosType = "eosuser"
...
batchQueue = "longlunch" #longlunch 

#Optional computing account when running on HTCondor, default is group_u_FCC.local_gen
compGroup = "group_u_FCC.local_gen"

userBatchConfig="/afs/cern.ch/user/k/kdewyspe/21_March/FCCeePhysicsPerformance/case-studies/higgs/mH-recoil/FCCAnalyses-config/MidTerm/mumu/userBatch.Config"
#USER DEFINED CODE
import ROOT
ROOT.gInterpreter.ProcessLine('''
  TMVA::Experimental::RBDT<> bdt("ZH_Recoil_BDT", "/eos/user/k/kdewyspe/25_April/FCCee/MidTerm/mumu/BDT/xgb_bdt.root");
...
class RDFanalysis():
    ...
    def analysers(df):
        df2 = (
            ...
            #.Define("MissingET", "HiggsTools::get_MissingET") # add 29/03/24 
            .Define("Test_MET", "HiggsTools::Merger(ReconstructedParticles)") # add 03/04/24
            .Define("MET_momentum_x", "return MissingET.momentum.x")
            .Define("MET_momentum", "return MissingET.momentum.x + MissingET.momentum.y + MissingET.momentum.z")
