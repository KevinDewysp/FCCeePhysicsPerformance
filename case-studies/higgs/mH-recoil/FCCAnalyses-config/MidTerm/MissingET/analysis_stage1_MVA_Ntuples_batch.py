...
processList = {
    ...
    #'wzp6_ee_mumuH_ecm365':{'chunks':0.01},
    # 'p8_ee_WW_mumu_ecm240':{'chunks':10},
    #'wzp6_egamma_eZ_Zmumu_ecm365':{'chunks':0.01},
    #'wzp6_gammae_eZ_Zmumu_ecm365':{'chunks':0.01},
    #'wzp6_ee_mumu_ecm365':{'chunks':0.01},
    #'p8_ee_ZZ_ecm365':{'chunks':0.01}
...
# outputDirEos= "/eos/user/k/kdewyspe/21_March/FCCee/MidTerm/mumu/MVAInputs4/"
outputDir="/eos/user/k/kdewyspe/MissingET/FCCee/MidTerm/mumu/MVAInputs/" # Local run 
eosType = "eosuser"
...
userBatchConfig="/afs/cern.ch/user/k/kdewyspe/21_March/FCCeePhysicsPerformance/case-studies/higgs/mH-recoil/FCCAnalyses-config/Winter2023/userBatch.Config"
#USER DEFINED CODE
import ROOT
