...
energy         = 240.0
collider       = 'FCC-ee'
inputDir       = '/eos/user/k/kdewyspe/MissingET/FCCee/MidTerm/mumu/BDT_analysis_samples/final/'
...
#yaxis          = ['lin']
outdir         = '/eos/user/k/kdewyspe/MissingET/FCCee/MidTerm/mumu/BDT_analysis_samples/plots/'
