...
processList = {
    #signal
    "wzp6_ee_mumuH_ecm240":{'chunks':10}, #20
    #signal mass
    ...
    #background: 
    # "p8_ee_WW_ecm240":{'chunks':10}, #80
    # "p8_ee_ZZ_ecm240":{'chunks':10}, #20
    # "wzp6_ee_mumu_ecm240":{'chunks':10}, #20
    # "wzp6_ee_tautau_ecm240":{'chunks':10}, #20
    #rare backgrounds:
    "wzp6_egamma_eZ_Zmumu_ecm240":{'chunks':10}, #20
    "wzp6_gammae_eZ_Zmumu_ecm240":{'chunks':10}, #20
    # "wzp6_gaga_mumu_60_ecm240":{'chunks':10}, #20
    # "wzp6_gaga_tautau_60_ecm240":{'chunks':10}, #20
    # "wzp6_ee_nuenueZ_ecm240":{'chunks':10}, #20
    }
...
outputDir= "/eos/user/k/kdewyspe/MissingET/FCCee/MidTerm/mumu/BDT_analysis_samples/"
eosType = "eosuser"
...
ROOT.gInterpreter.ProcessLine('''
  TMVA::Experimental::RBDT<> bdt("ZH_Recoil_BDT", "/eos/user/k/kdewyspe/21_March/FCCee/MidTerm/mumu/BDT/xgb_bdt.root");
...
class RDFanalysis():
    ...
    def analysers(df):
        df2 = (
            ...
            .Define("MissET", "return MissingET")
            .Define("MissET_mass", "return MissingET.mass")
            .Define("MissET_p", "return MissingET.momentum.x + MissingET.momentum.y + MissingET.momentum.z")
            .Define("MissET_pT", "return MissingET.momentum.x + MissingET.momentum.y")
            .Define("MissET_px", "return MissingET.momentum.x")
            .Define("MissET_py", "return MissingET.momentum.y")
            .Define("MissET_pz", "return MissingET.momentum.z")
