...
energy         = 240.0
collider       = 'FCC-ee'
inputDir       = '/eos/user/k/kdewyspe/21_March/FCCee/MidTerm/mumu/BDT_analysis_samples/final_speed/'
#inputDir       = '/eos/user/k/kdewyspe/21_March/FCCee/MidTerm_365/mumu/BDT_analysis_samples_trained/final/'
...
#stacksig       = ['stack']
formats        = ['png'] #,'eps','tex','pdf',]
#yaxis          = ['lin']
outdir         = '/eos/user/k/kdewyspe/21_March/FCCee/MidTerm/mumu/BDT_analysis_samples/plots_more/'
#outdir         = '/eos/user/k/kdewyspe/21_March/FCCee/MidTerm_365/mumu/BDT_analysis_samples_trained/plots_diapo/'
...
variables = [  #muons
            ...
            #    "leptonic_recoil_m_zoom7",
               "leptonic_recoil_m_zoom8",
               # "leptonic_recoil_m_zoom9",
            #    "BDT_Score",
               #control vaiables
...
extralabel["sel0_MRecoil_Mll_73_120_pll_05_MVA01_costhetamiss"]  = "0 < m_{l^-l^+} < 120" 
extralabel["sel0_MRecoil_Mll_73_120_pll_05_MVA02_costhetamiss"]  = "120 < m_{l^-l^+} < 180" 
extralabel["sel0_MRecoil_Mll_73_120_pll_05_MVA03_costhetamiss"]  = "180 < m_{l^-l^+} < 250" 
