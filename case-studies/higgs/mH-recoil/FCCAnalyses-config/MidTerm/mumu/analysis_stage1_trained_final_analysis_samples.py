...
inputDir = "/eos/user/k/kdewyspe/21_March/FCCee/MidTerm/mumu/BDT_analysis_samples"

#Input directory where the files produced at the pre-selection level are
outputDir = "/eos/user/k/kdewyspe/21_March/FCCee/MidTerm/mumu/BDT_analysis_samples/final_speed"
...
cutList = { 
            ...
            # "sel_Baseline_MVA01": "zll_recoil_m > 120 &&zll_recoil_m <140 && zll_p > 20 && zll_p <70 && cosTheta_miss.size() >=1 && cosTheta_miss[0] > -0.98 && cosTheta_miss[0]  < 0.98",
            # "sel_Baseline_MVA02":"zll_recoil_m > 120 &&zll_recoil_m <140 && zll_p > 20 && zll_p <70",
            ...
            # "sel_Baseline_no_costhetamiss":"zll_recoil_m > 120 && zll_recoil_m  <140 && zll_p  > 20 && zll_p  <70",
            ...
            # "sel_Baseline_without_mrec_1":"zll_m > 0 && zll_m < 120 ",
            # "sel_Baseline_without_mrec_2":"zll_m > 120 && zll_m < 180",
            # "sel_Baseline_without_mrec_3":"zll_m > 180 && zll_m < 250",
          ...
          ### test for mz analysis 14/05/24

            # "sel0_MRecoil_Mll_73_120_pll_05_MVA01_costhetamiss":"zll_m > 0 && zll_m < 120",
            # "sel0_MRecoil_Mll_73_120_pll_05_MVA02_costhetamiss":"zll_m > 120 && zll_m < 180",
            # "sel0_MRecoil_Mll_73_120_pll_05_MVA03_costhetamiss":"zll_m > 180 && zll_m < 250", 
            }
...
histoList = {
    ...
    "leptonic_recoil_m_zoom8":{"name":"zll_recoil_m","title":"Z leptonic recoil [GeV]","bin":252,"xmin":0,"xmax":350}, 
    # "BDT_Score":{"name":"BDTscore","title":"BDT Score","bin":100,"xmin":0.,"xmax":1.0},
    # "BDT_Score":{"name":"BDTscore","title":"BDT Score","bin":100,"xmin":-0.05,"xmax":1.05},  
    ...
    # "zll_leptons_acolinearity":{"name":"zll_leptons_acolinearity","title":"acolinearity","bin":100,"xmin":-1,"xmax":4},
    # "zll_leptons_acoplanarity":{"name":"zll_leptons_acoplanarity","title":"acoplanarity","bin":100,"xmin":-1,"xmax":4},
    # "cosTheta_miss":{"name":"cosTheta_miss","title":"cos#theta_{missing}","bin":210,"xmin":-1.05,"xmax":1.05},
    #"Test_MET":{"name":"Test_MET","title":"Test_MET","bin":200,"xmin":-80,"xmax":80}, # add 03/04/24
    #"MissingET":{"name":"MissingET","title":"MissingET","bin":200,"xmin":-80,"xmax":80},
    #"MET_momentum":{"name":"MET_momentum","title":"MET_momentum","bin":200,"xmin":-80,"xmax":80},
    #"MET_momentum_x":{"name":"MET_momentum_x","title":"MET_momentum_x","bin":200,"xmin":-80,"xmax":80},
    ...
    # "leading_zll_lepton_theta":{"name":"leading_zll_lepton_theta","title":"leading_zll_lepton_theta","bin":70,"xmin":-0.5,"xmax":3.5},
    ...
    # "subleading_zll_lepton_theta":{"name":"subleading_zll_lepton_theta","title":"subleading_zll_lepton_theta","bin":70,"xmin":-0.5,"xmax":3.5},
    ...
    # "zll_theta":{"name":"zll_theta","title":"zll_theta","bin":70,"xmin":-0.5,"xmax":3.5},
