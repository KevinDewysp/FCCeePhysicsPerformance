...
energy         = 240.0
collider       = 'FCC-ee'
inputDir       = '/eos/user/k/kdewyspe/21_March/FCCee/MidTerm/ee/BDT_analysis_samples/final_speed/'
#formats        = ['png','pdf']
yaxis          = ['lin','log']
#yaxis          = ['lin']
...
formats        = ['png']
#yaxis          = ['lin']
outdir         = '/eos/user/k/kdewyspe/21_March/FCCee/MidTerm/ee/BDT_analysis_samples/plots_more/'
