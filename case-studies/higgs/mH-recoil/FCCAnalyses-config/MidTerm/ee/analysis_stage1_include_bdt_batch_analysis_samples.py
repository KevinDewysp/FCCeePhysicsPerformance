...
outputDirEos= "/eos/user/k/kdewyspe/04_May/FCCee/MidTerm/ee/BDT_analysis_samples_noisol/"
eosType = "eosuser"
...
ROOT.gInterpreter.ProcessLine('''
  TMVA::Experimental::RBDT<> bdt("ZH_Recoil_BDT", "/eos/user/k/kdewyspe/21_March/FCCee/MidTerm/ee/BDT/xgb_bdt.root");
