...
processList = {
    # #signal
    # "wzp6_ee_eeH_ecm240":{'chunks':3}, #done
    # #singl_mass
    ...
    # #background
    "p8_ee_WW_ecm240":{'chunks':10}, #en cours #+condor
    "p8_ee_ZZ_ecm240":{'chunks':10}, #en cours #+condor
    "wzp6_ee_ee_Mee_30_150_ecm240":{'chunks':10}, #en cours #+condor
    # "wzp6_ee_tautau_ecm240":{'chunks':3}, #en cours
    # #background rare
    # "wzp6_egamma_eZ_Zee_ecm240":{'chunks':3}, #en cours
    # "wzp6_gammae_eZ_Zee_ecm240":{'chunks':3}, #en cours
    # "wzp6_gaga_ee_60_ecm240":{'chunks':3}, #en cours
    # "wzp6_gaga_tautau_60_ecm240":{'chunks':3}, #en cours
    # "wzp6_ee_nuenueZ_ecm240":{'chunks':3} #en cours 
    }
...
outputDirEos= "/eos/user/k/kdewyspe/25_April/FCCee/MidTerm/ee/BDT_analysis_samples_condor/"
eosType = "eosuser"
...
userBatchConfig="/afs/cern.ch/user/k/kdewyspe/21_March/FCCeePhysicsPerformance/case-studies/higgs/mH-recoil/FCCAnalyses-config/MidTerm/ee/userBatch.Config"
#USER DEFINED CODE
import ROOT
ROOT.gInterpreter.ProcessLine('''
  TMVA::Experimental::RBDT<> bdt("ZH_Recoil_BDT", "/eos/user/k/kdewyspe/25_April/FCCee/MidTerm/ee/BDT/xgb_bdt.root");
