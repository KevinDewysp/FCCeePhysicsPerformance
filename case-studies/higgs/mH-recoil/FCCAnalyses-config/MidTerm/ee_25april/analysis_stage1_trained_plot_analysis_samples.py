...
energy         = 240.0
collider       = 'FCC-ee'
inputDir       = '/eos/user/k/kdewyspe/25_April/FCCee/MidTerm/ee/BDT_analysis_samples/final/'
#formats        = ['png','pdf']
yaxis          = ['lin','log']
#yaxis          = ['lin']
...
formats        = ['pdf','png','tex']
#yaxis          = ['lin']
outdir         = '/eos/user/k/kdewyspe/25_April/FCCee/MidTerm/ee/BDT_analysis_samples/plots/'
