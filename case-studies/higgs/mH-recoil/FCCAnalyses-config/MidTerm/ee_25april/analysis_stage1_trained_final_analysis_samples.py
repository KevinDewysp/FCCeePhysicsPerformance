...
inputDir = "/eos/user/k/kdewyspe/25_April/FCCee/MidTerm/ee/BDT_analysis_samples"

#Input directory where the files produced at the pre-selection level are
outputDir = "/eos/user/k/kdewyspe/25_April/FCCee/MidTerm/ee/BDT_analysis_samples/final"
